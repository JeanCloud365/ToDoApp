...
namespace ToDoApp.Client
{
    ...
    public partial interface IClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task DeleteWebhookAsync(System.Guid id);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <summary>Remove a webhook</summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task DeleteWebhookAsync(System.Guid id, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class Client : IClient
    {
        ...
        /// <summary>Remove a webhook</summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task DeleteWebhookAsync(System.Guid id)
        {
        ...
        /// <summary>Remove a webhook</summary>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task DeleteWebhookAsync(System.Guid id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("api/Webhook/{id}");
            urlBuilder_.Replace("{id}", System.Uri.EscapeDataString(ConvertToString(id, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    {
        [Newtonsoft.Json.JsonConstructor]
        public GetTodoUserWebhookViewModel(System.Collections.Generic.ICollection<GetToDoUserWebhookDto> @items)
        {
            this.Items = @items;
        }
    
        [Newtonsoft.Json.JsonProperty("items", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<GetToDoUserWebhookDto> Items { get; }
    ...
    {
        [Newtonsoft.Json.JsonConstructor]
        public GetToDoUserWebhookDto(System.Guid @id, string @webhookUrl)
        {
            this.WebhookUrl = @webhookUrl;
            this.Id = @id;
        }
